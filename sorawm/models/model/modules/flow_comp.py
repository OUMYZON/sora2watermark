...
def flow_warp(x,
    ...
    # TODO: I don't does it influnce its performance, but we will see it later.
    # MPS (Apple Silicon) doesn't support 'border' padding mode
    # Fallback to 'zeros' which produces similar results
    if padding_mode == 'border' and x.device.type == 'mps':
        padding_mode = 'zeros'
